...
export const theme = {
  ...
  atom: {
    ...
    floatAmplitude: 0.08,
    floatSpeed: 0.6,
    bondColor: "#4a5568", // sleek metallic gray
    bondRadius: 0.045,
    atomColors: {
      C: "#8a929c", // carbon — clean metallic gray (Neutral / Maker Orders)
      H: "#f0f4f1", // hydrogen — soft white (Micro-Transactions)
      N: "#3aa9ff", // nitrogen — cool blue (Liquidity Pools)
      O: "#ff5da2", // oxygen — magenta/pink (Resistance)
      D: "#1c1f22", // dark node — pitch black (Dark Pools)
      P: "#b46bff", // phosphorus
      S: "#ffd84d", // sulfur
    },
    atomRadii: {
